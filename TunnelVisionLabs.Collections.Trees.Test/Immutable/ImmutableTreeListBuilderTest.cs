...
namespace TunnelVisionLabs.Collections.Trees.Test.Immutable
{
    ...
    public class ImmutableTreeListBuilderTest
    {
        ...
        {
            TestICollectionInterfaceImpl(ImmutableTreeList.Create(600, 601).ToBuilder(), supportsNullValues: false);
            ...
            TestICollectionInterfaceImpl(ImmutableList.Create(600, 601).ToBuilder(), supportsNullValues: false);
            TestICollectionInterfaceImpl(ImmutableList.Create<int?>(600, 601).ToBuilder(), supportsNullValues: true);
            TestICollectionInterfaceImpl(ImmutableList.Create<object>(600, 601).ToBuilder(), supportsNullValues: true);
        }

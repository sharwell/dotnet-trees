...
namespace TunnelVisionLabs.Collections.Trees.Immutable
{
    ...
    public sealed partial class ImmutableTreeDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary
    {
        ...
        private ImmutableTreeDictionary()
            : this(ImmutableTreeSet<KeyValuePair<TKey, TValue>>.Empty.WithComparer(KeyOfPairComparer.Default), null, null)
        {
        }
        ...
        public ImmutableTreeDictionary<TKey, TValue> AddRange(IEnumerable<KeyValuePair<TKey, TValue>> pairs) => throw null;
        ...
        public bool ContainsValue(TValue value) => _treeSet.Any(pair => ValueComparer.Equals(pair.Value, value));
        ...
        {
            var result = _treeSet.Remove(new KeyValuePair<TKey, TValue>(key, default));
            if (result == _treeSet)
            {
                return this;
            }
        ...
        public ImmutableTreeDictionary<TKey, TValue> RemoveRange(IEnumerable<TKey> keys)
        {
            ...
            var result = _treeSet.Except(keys.Select(key => new KeyValuePair<TKey, TValue>(key, default)));
            if (result == _treeSet)
            {
                return this;
            }
        ...
        public ImmutableTreeDictionary<TKey, TValue> SetItem(TKey key, TValue value) => throw null;

        public ImmutableTreeDictionary<TKey, TValue> SetItems(IEnumerable<KeyValuePair<TKey, TValue>> items) => throw null;
        ...
        IImmutableDictionary<TKey, TValue> IImmutableDictionary<TKey, TValue>.SetItem(TKey key, TValue value) => SetItem(key, value);
        ...
        IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator() => new Enumerator(_treeSet.GetEnumerator(), Enumerator.ReturnType.KeyValuePair);
